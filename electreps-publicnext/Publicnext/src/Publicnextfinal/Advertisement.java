					...
					String newstitle = sheet.getRow(row).getCell(0).getStringCellValue();//it will take 1st row of first cell value
					 String location= sheet.getRow(row).getCell(1).getStringCellValue();
			            ...
			            DataFormatter formatter1 = new DataFormatter(); //creating formatter using the default locale
						 XSSFCell cell1 = sheet.getRow(row).getCell(6);
						...
						DataFormatter formatter2 = new DataFormatter(); //creating formatter using the default locale
						 XSSFCell cell2 = sheet.getRow(row).getCell(7);
...
driver.get("https://qa.electreps.com/node/add/advertisement");
...
//from date
			...
			//Thread.sleep(1000);
			//WebElement dd =driver.findElement(By.xpath("//*[@id=\"edit-field-event-start-date-und-0-value-datepicker-popup-0\"]"));
			//dd.sendKeys(asd);
//from date			
			driver.findElement(By.xpath("//*[@id=\"edit-field-event-start-date-und-0-value-datepicker-popup-0\"]")).clear();
			Thread.sleep(1000);
			
			WebElement toda1 = driver.findElement(By.xpath("//*[@id=\"edit-field-event-start-date-und-0-value-datepicker-popup-0\"]"));
			//toda1.click();
			toda1.sendKeys(fromd);
			driver.findElement(By.xpath("//*[@id=\"field-event-start-date-add-more-wrapper\"]/fieldset/div/div[2]")).click();
			//Thread.sleep(4000);
...
//to date			
			...
			WebElement toda2 = driver.findElement(By.xpath("//*[@id=\"edit-field-event-start-date-und-0-value2-datepicker-popup-0\"]"));
			//toda1.click();
			toda2.sendKeys(fromd1);
			driver.findElement(By.xpath("//*[@id=\"field-event-start-date-add-more-wrapper\"]/fieldset/div/div[2]")).click();
			//Thread.sleep(4000);
