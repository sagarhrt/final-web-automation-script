...
public class editorlatlng {

		public static void main(String[] args) throws Exception {
			 System.setProperty("webdriver.chrome.driver", "E:\\softwares\\chromedriver.exe");
				WebDriver driver = new ChromeDriver();
				driver.manage().window().maximize();
				driver.get("https://prod.publicnext.com/user/login");
				...
				password.sendKeys("sa@electreps");
				 Thread.sleep(1000);
		...
		//select add content menu//
						...
						act.moveToElement(driver.findElement(By.xpath("//*[@id=\"admin-menu-menu\"]/li/ul/li[4]/a"))).click().perform();
						Thread.sleep(1000);
