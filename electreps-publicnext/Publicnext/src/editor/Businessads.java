...
public class Businessads {
		        ...
		        for (int row=1; row<=rowCount; row++)
		        {
					...
					String newstitle = sheet.getRow(row).getCell(0).getStringCellValue();//it will take 1st row of first cell value
					 String city= sheet.getRow(row).getCell(1).getStringCellValue();
			            ...
			            int mobilenum= (int)sheet.getRow(row).getCell(8).getNumericCellValue();
			            System.out.println("Data from Excel is >>> "+mobilenum);
 ...
 //selecting main menu after login to https://qa.electreps.com/
	...
	//select advertisement menu 
				...
				act1.moveToElement(driver.findElement(By.xpath("//*[@id=\"admin-menu-menu\"]/li[1]/ul/li[1]/a"))).click().perform();
...
//adding mobile number
				WebElement mo= driver.findElement(By.xpath("//*[@id=\"edit-field-phone-number-und-0-value\"]"));
				//mo.sendKeys(mobilenum);
